...
bool LoadModuleGLES(void* (*loader)(const char*))
{
    ...
    LOAD_OPTIONAL_SYMBOL(GLES32, glBlendEquationi);
    LOAD_OPTIONAL_SYMBOL(GLES32, glBlendEquationSeparatei);
    LOAD_OPTIONAL_SYMBOL(GLES32, glBlendFunci);
    LOAD_OPTIONAL_SYMBOL(GLES32, glBlendFuncSeparatei);
    LOAD_OPTIONAL_SYMBOL(GLES32, glColorMaski);
    LOAD_OPTIONAL_SYMBOL(GLES32, glCopyImageSubData);
    LOAD_OPTIONAL_SYMBOL(GLES32, glDebugMessageCallback);
    LOAD_OPTIONAL_SYMBOL(GLES32, glDebugMessageControl);
    LOAD_OPTIONAL_SYMBOL(GLES32, glDebugMessageInsert);
    LOAD_OPTIONAL_SYMBOL(GLES32, glDisablei);
    LOAD_OPTIONAL_SYMBOL(GLES32, glDrawElementsBaseVertex);
    LOAD_OPTIONAL_SYMBOL(GLES32, glDrawElementsInstancedBaseVertex);
    LOAD_OPTIONAL_SYMBOL(GLES32, glDrawRangeElementsBaseVertex);
    LOAD_OPTIONAL_SYMBOL(GLES32, glEnablei);
    LOAD_OPTIONAL_SYMBOL(GLES32, glFramebufferTexture);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetDebugMessageLog);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetGraphicsResetStatus);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetnUniformfv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetnUniformiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetnUniformuiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetObjectLabel);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetObjectPtrLabel);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetPointerv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetSamplerParameterIiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetSamplerParameterIuiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetTexParameterIiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glGetTexParameterIuiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glIsEnabledi);
    LOAD_OPTIONAL_SYMBOL(GLES32, glMinSampleShading);
    LOAD_OPTIONAL_SYMBOL(GLES32, glObjectLabel);
    LOAD_OPTIONAL_SYMBOL(GLES32, glObjectPtrLabel);
    LOAD_OPTIONAL_SYMBOL(GLES32, glPatchParameteri);
    LOAD_OPTIONAL_SYMBOL(GLES32, glPopDebugGroup);
    LOAD_OPTIONAL_SYMBOL(GLES32, glPrimitiveBoundingBox);
    LOAD_OPTIONAL_SYMBOL(GLES32, glPushDebugGroup);
    LOAD_OPTIONAL_SYMBOL(GLES32, glReadnPixels);
    LOAD_OPTIONAL_SYMBOL(GLES32, glSamplerParameterIiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glSamplerParameterIuiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glTexBuffer);
    LOAD_OPTIONAL_SYMBOL(GLES32, glTexBufferRange);
    LOAD_OPTIONAL_SYMBOL(GLES32, glTexParameterIiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glTexParameterIuiv);
    LOAD_OPTIONAL_SYMBOL(GLES32, glTexStorage3DMultisample);
