...
extern struct _libX11_so {
    ...
    // XBool              (*XEmptyRegion)(XRegion);
    // XBool              (*XEqualRegion)(XRegion,XRegion);
    // int32_t            (*XFindContext)(XDisplay*,XID,XContext,void**);
    // XStatus            (*XGetClassHint)(XDisplay*,XWindowXClassHint*);
    // Status             (*XGetIconSizes)(XDisplay*,XWindow,XIconSize**,int32_t*); 
    // Status             (*XGetNormalHints)(XDisplay*,XWindow,XSizeHints*); 
    // Status             (*XGetRGBColormaps)(XDisplay*,XWindow,XStandardColormap**,int32_t*,XAtom); 
    // Status             (*XGetSizeHints)(XDisplay*,XWindow,XSizeHints*,XAtom); 
    // Status             (*XGetStandardColormap)(XDisplay*,XWindow,XStandardColormap*,XAtom); 
    // Status             (*XGetTextProperty)(XDisplay*,XWindow,XTextProperty*,XAtom); 
    // XVisualInfo*       (*XGetVisualInfo)(XDisplay*,int64_t,XVisualInfo*,int32_t*); 
    // Status             (*XGetWMClientMachine)(XDisplay*,XWindow,XTextProperty*); 
    // XWMHints*          (*XGetWMHints)(XDisplay*,XWindow); 
    // Status             (*XGetWMIconName)(XDisplay*,XWindow,XTextProperty*); 
    // Status             (*XGetWMName)(XDisplay*,XWindow,XTextProperty*); 
    // Status             (*XGetWMNormalHints)(XDisplay*,XWindow,XSizeHints*,int64_t*); 
    // Status             (*XGetWMSizeHints)(XDisplay*,XWindow,XSizeHints*,int64_t*,XAtom); 
    // Status             (*XGetZoomHints)(XDisplay*,XWindow,XSizeHints*); 
    ...
    // Status             (*XMatchVisualInfo)(XDisplay*,int32_t,int32_t,int32_t,XVisualInfo*); 
    // int32_t            (*XOffsetRegion)(XRegion,int32_t,int32_t); 
    // XBool              (*XPointInRegion)(XRegion,int32_t,int32_t); 
    ...
    // int32_t            (*XSetRegion)(XDisplay*,GC,XRegion); 
    ...
    // XStatus            (*XStringListToTextProperty)(char**,int32_t,XTextProperty*); 
    ...
    // XStatus            (*XTextPropertyToStringList)(XTextProperty*,char***,int32_t*); 
